        ...
        <section className="py-24 px-4 sm:px-6 overflow-hidden" style={{ background: '#F8F9FA' }}>
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                >
                    ...
                    <h2 className="font-heading text-4xl md:text-5xl font-bold text-[#0B1F22] leading-tight mb-5">
                        Your Trusted{' '}
                        <span className="italic" style={{ color: '#0F3D3E' }}>Real Estate</span>
                        <br />
                        Partner
                    </h2>
                    ...
                    <ul className="space-y-3 mb-10">
                        {highlights.map((h) => (
                            <li key={h} className="flex items-center gap-3 text-gray-700 font-body">
                                <HiCheckCircle className="text-[#CBA135] text-xl flex-shrink-0" />
                                {h}
                            </li>
                        ))}
                    </ul>
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="absolute -bottom-6 -left-6 glass-dark rounded-2xl px-5 py-4 text-center shadow-gold"
                        style={{ minWidth: 140 }}
                    >
                        <p className="font-heading text-3xl font-bold text-[#CBA135]">8+</p>
                        <p className="text-white/70 text-xs font-body tracking-wide mt-1">Years of<br />Excellence</p>
                    </motion.div>

                    {/* Decorative Ring */}
                    <div className="absolute -top-8 -right-8 w-32 h-32 rounded-full border-2 border-[#CBA135]/20 pointer-events-none" />
                    <div className="absolute -top-4 -right-4 w-20 h-20 rounded-full border-2 border-[#CBA135]/30 pointer-events-none" />
                </motion.div>
            </div>
        </section>
    )
